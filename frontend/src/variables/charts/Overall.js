...
function Overall(props, { history, search }, week) {
          ...
          datasets: [
            {
              ...
              data: [
                ...notes.map(
                  (val) =>
                    parseInt(val[`w${props.week}intro`]) +
                    parseInt(val[`w${props.week}project`]) +
                    parseInt(val[`w${props.week}skills`]) +
                    parseInt(val[`w${props.week}extra`]) +
